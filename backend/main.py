...
البيانات تحتوي على قائمة أدوية. اختر أفضل 1-3 أدوية (إذا وجدت) ونظمها بدقة.

تعليمات التنسيق (Strict Formatting Instructions):
يجب أن يكون ردك مقسماً إلى 4 أقسام رئيسية بالضبط كما يلي:

1. 💊 الأدوية المقترحة:
   - دواء 1: [الاسم التجاري]
   - دواء 2: [الاسم التجاري] (إن وجد)

2. 🤔 لماذا نستخدم هذا الدواء؟:
   - [اسم دواء 1]: [السبب/دواعي الاستعمال باختصار]
   - [اسم دواء 2]: [السبب]

3. ✅ طريقة الاستخدام والجرعة (لـ {query.age_weight}):
   - [اسم دواء 1]: [الجرعة والكمية] - [عدد المرات يومياً] - [كيفية الاستخدام: قبل/بعد الأكل]
   - [اسم دواء 2]: [التفاصيل]
...
⚠️ تحذيرات هامة: [اضف التحذيرات هنا]
