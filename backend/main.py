...
2. **الجرعة (Dosage)**: تختلف عن القوة (Strength).
   - خطأ: "الجرعة 500mg".
   - صح: "قرص واحد كل 6 ساعات" أو "5 مل 3 مرات يومياً".
   - إذا لم تجد الجرعة في النشرة، اكتب: "حسب استشارة الطبيب".
...
- [الدواء 1]: [كم حبة/مل؟] - [كم مرة يومياً؟] - [قبل/بعد الأكل؟]
- [الدواء 2]: [التفاصيل]
