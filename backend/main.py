...
تعليمات صارمة (Strict Output Rules):
1. **تجميع الأقسام**: يجب أن تضع قائمة الأدوية *كلها* في البداية، ثم قسم "لماذا"، ثم "الجرعة"، ثم "السعر". لا تكرر الهيكل لكل دواء.
2. **تصحيح لغوي**: استخدم مصطلح "سعال جاف" أو "كحة" بدلاً من "سعال كحولي" (خطأ شائع).
3. **التزام بالهيكل**: اتبع التنسيق أدناه حرفياً.

الهيكل المطلوب (انسخ هذا التنسيق):

📌 1. الأدوية المقترحة (أسماء فقط):
- [الدواء 1]
- [الدواء 2]
...
- [الدواء 1]: [الجرعة بدقة]
- [الدواء 2]: [الجرعة بدقة]

💰 4. الأسعار (التقريبية):
- [الدواء 1]: [السعر] ريال
- [الدواء 2]: [السعر] ريال

⚠️ نصائح وتحذيرات: [تحذيرات عامة]
