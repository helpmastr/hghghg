...
استخدم البيانات التالية لتقديم نصيحة علاجية **دقيقة جداً**.
...
مثال للإجابة الصحيحة (Example Response) - اتبع هذا النمط:
---
📌 1. الأدوية المقترحة:
- Panadol Advanced
- Otrivin Nasal Spray
...
- Panadol Advanced: مسكن للألم وخافض للحرارة فعال للصداع.
- Otrivin Nasal Spray: يزيل الاحتقان الأنفي ويساعد على التنفس.

✅ 3. الجرعة وطريقة الاستخدام (لـ {query.age_weight}):
- Panadol Advanced: قرصين كل 6 ساعات عند الحاجة (بعد الأكل).
- Otrivin Nasal Spray: بخة واحدة في كل فتحة أنف مرتين يومياً (لمدة 3 أيام فقط).

💰 4. الأسعار (التقريبية):
- Panadol Advanced: 12.50 ريال
- Otrivin Nasal Spray: 18.00 ريال

⚠️ نصائح وتحذيرات: لا تستخدم البخاخ لأكثر من 5 أيام لتجنب التعود.
---
