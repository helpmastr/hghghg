...
1. **عدم التكرار**: إذا وجدت نفس الدواء بأشكال مختلفة (مثلاً: نقط وبخاخ لنفس البراند)، اختر واحداً فقط (الأفضل للعمر).
2. **القائمة الأولى أسماء فقط**: في قسم "الأدوية المقترحة"، اكتب الاسم التجاري فقط (بدون التفاصيل الفنية أو السعر).
3. **الأسعار**: ضع الأسعار حصراً في القسم المخصص لها في النهاية.
